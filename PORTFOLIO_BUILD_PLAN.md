...
Build a portfolio that proves capability through serious projects, not small clones.

## Project Standards

Every portfolio project should eventually include:
...
- Short case study.
- Roadmap.
- Security notes if it touches secrets, AI, or user data.
